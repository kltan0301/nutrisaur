...
export declare function handleGoalRemind(request: AgentRequest): Promise<AgentResponse<UserGoal | null>>;
...
export declare function handleCaloriesRemaining(request: AgentRequest): Promise<AgentResponse<SummaryData | null>>;

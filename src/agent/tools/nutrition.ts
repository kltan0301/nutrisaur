 ...
 */
function findNutritionMatch(input: string): NutritionInfo | null {
...
export async function analyzeFood(
  request: AnalyzeFoodRequest | string
): Promise<ToolResponse<NutritionInfo>> {
  try {
 ...
 */
export function isFoodSupported(food: string): boolean {
 ...
 */
export function addCustomFood(key: string, nutrition: NutritionInfo): void {
